...
class FilterByColumn:
    def setupUi(self, df_operations_window):
        ...
        self.col_results_btn = QtWidgets.QPushButton(df_operations_window)
        self.col_results_btn.setGeometry(QtCore.QRect(160, 110, 111, 28))
        self.col_results_btn.setObjectName("show_results_btn")
    ...
    def retranslateUi(self, df_operations_window):
        ...
        self.col_results_btn.setText(_translate("df_operations_window", "Show results"))
...
if __name__ == "__main__":
    ...
    ui_filter_col = FilterByColumn()
    ui_filter_col.setupUi(filter_col)
    filter_col.show()
    sys.exit(app.exec_())
